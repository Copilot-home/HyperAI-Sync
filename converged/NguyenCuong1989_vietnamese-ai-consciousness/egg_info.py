...
class manifest_maker(sdist):
    ...
    def _safe_data_files(self, build_py):
        ...
        warnings.warn("Custom 'build_py' does not implement " "'get_data_files_without_manifest'.\nPlease extend command classes" " from setuptools instead of distutils.", SetuptoolsDeprecationWarning, stacklevel=2)
...
def get_pkg_info_revision():
    ...
    """
    warnings.warn("get_pkg_info_revision is deprecated.", EggInfoDeprecationWarning, stacklevel=2)
